...
<link rel="stylesheet" id="ct_public_css-css" href="http://localhost/Seedling_Theater_Company/wp-content/plugins/cleantalk-spam-protect/css/cleantalk-public.min.css?ver=6.9.1" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/Seedling_Theater_Company/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
					...
					<p id="nav">
				<a href="http://localhost/Seedling_Theater_Company/my-account/lost-password/">Lost your password?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="http://localhost/Seedling_Theater_Company/">&larr; Go to Seedling Theater Company</a>		</p>
			</div>
			<script id="zxcvbn-async-js-extra">var _zxcvbnSettings = {"src":"http:\/\/localhost\/Seedling_Theater_Company\/wp-includes\/js\/zxcvbn.min.js"};</script>
<script src="http://localhost/Seedling_Theater_Company/wp-includes/js/zxcvbn-async.min.js?ver=1.0" id="zxcvbn-async-js"></script>
<script src="http://localhost/Seedling_Theater_Company/wp-includes/js/dist/vendor/wp-polyfill-inert.min.js?ver=3.1.2" id="wp-polyfill-inert-js"></script>
<script src="http://localhost/Seedling_Theater_Company/wp-includes/js/dist/vendor/regenerator-runtime.min.js?ver=0.13.11" id="regenerator-runtime-js"></script>
<script src="http://localhost/Seedling_Theater_Company/wp-includes/js/dist/vendor/wp-polyfill.min.js?ver=3.15.0" id="wp-polyfill-js"></script>
<script src="http://localhost/Seedling_Theater_Company/wp-includes/js/dist/hooks.min.js?ver=4169d3cf8e8d95a3d6d5" id="wp-hooks-js"></script>
<script src="http://localhost/Seedling_Theater_Company/wp-includes/js/dist/i18n.min.js?ver=9e794f35a71bb98672ae" id="wp-i18n-js"></script>
<script id="wp-i18n-js-after">
wp.i18n.setLocaleData( { 'text directionltr': [ 'ltr' ] } );
</script>
<script id="password-strength-meter-js-extra">var pwsL10n = {"unknown":"Password strength unknown","short":"Very weak","bad":"Weak","good":"Medium","strong":"Strong","mismatch":"Mismatch"};</script>
<script src="http://localhost/Seedling_Theater_Company/wp-admin/js/password-strength-meter.min.js?ver=6.2" id="password-strength-meter-js"></script>
<script src="http://localhost/Seedling_Theater_Company/wp-content/plugins/the-events-calendar/common/src/resources/js/underscore-before.js"></script>
<script src="http://localhost/Seedling_Theater_Company/wp-includes/js/underscore.min.js?ver=1.13.4" id="underscore-js"></script>
